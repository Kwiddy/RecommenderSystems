...
def generate_recommendations(user_id, users_df):
    ...
    if len(review_search) == 0:
        ...
        display_results(result, businesses_df, to_display, True, covid_df)
    else:
        ...
        # Display the results
        display_results(first_recommendations, businesses_df, to_display, False, covid_df)
...
def display_results(results, businesses_df, return_num, no_reviews, covid_df):
