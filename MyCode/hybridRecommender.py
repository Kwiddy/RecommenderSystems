...
def generate_recommendations(user_id, users_df):
    ...
    if len(review_search) == 0:
        ...
        first_recommendations, refined_businesses, explanatory_refs = collaborative_recommender(user_id)
        ...
        # Display the results
        display_results(user_id, final_recommendations, businesses_df, to_display, False, covid_df, explanatory_refs)
...
def display_results(user, results, businesses_df, return_num, no_reviews, covid_df, explanatory_refs):
    ...
    while show_more:
        ...
        for item in results[start:end]:
            ...
            # Add an explanatory column
            ref_found = False
            for ref in explanatory_refs:
                if ref[0] == item_id:
                    id_search = businesses_df[businesses_df["business_id"] == ref[1]]
                    name = id_search['name'].iloc[0]
                    explanation = "Because you liked: " + name
                    ref_found = True
                    break
            if not ref_found:
                explanation = ""
